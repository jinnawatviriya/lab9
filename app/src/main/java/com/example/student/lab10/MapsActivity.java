...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.addMarker(new MarkerOptions().position(LL).title("Location Change " + ++n));
        ...
        if(n != 1)
            mMap.addPolyline(new PolylineOptions().add(a).add(LL));
        a = LL;
    }
    ...
    private void setUpMap() {
        ...
        //move map center point
        CameraUpdate center_point = CameraUpdateFactory.newLatLng(VT);
        mMap.moveCamera(center_point);
